...
### Create school
```bash
curl --location 'localhost:8222/school-service/api/v1/schools' \
...
### Create student
```bash
curl --location 'localhost:8222/student-service/api/v1/students' \
--header 'Content-Type: application/json' \
--data-raw '{
    "firstname": "vu",
    "lastname": "trunganh",
    "email": "vutrunganh@email.com",
    "schoolId": 1
}'
```

### Get student in school (student service)
```bash
curl --location 'localhost:8222/student-service/api/v1/students/school/1'
```

### Get school and all students
```bash
curl --location 'localhost:8222/school-service/api/v1/schools/1/students/'
```