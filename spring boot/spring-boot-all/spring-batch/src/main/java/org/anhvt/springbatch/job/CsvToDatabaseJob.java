package org.anhvt.springbatch.job;

import org.anhvt.springbatch.listener.JobCompletionNotificationListener;
import org.anhvt.springbatch.listener.PersonItemReadListener;
import org.anhvt.springbatch.model.Person;
import org.anhvt.springbatch.processor.PersonItemProcessor;
import org.anhvt.springbatch.tasklets.DeleteInputCsvTasklet;
...
//                .processor(processor)
    ...
    public FlatFileItemReader<Person> csvFileReader(LineMapper<Person> lineMapper) {
        ...
        if (!inputFeed.exists()) {
            logger.error("Input CSV file does not exist: " + inputFeed.getFilename());
        }
        return itemReader;
    }
